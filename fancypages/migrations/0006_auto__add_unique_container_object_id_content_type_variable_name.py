...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Container', fields ['object_id', 'content_type', 'variable_name']
        db.create_unique('fancypages_container', ['object_id', 'content_type_id', 'variable_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Container', fields ['object_id', 'content_type', 'variable_name']
        db.delete_unique('fancypages_container', ['object_id', 'content_type_id', 'variable_name'])
