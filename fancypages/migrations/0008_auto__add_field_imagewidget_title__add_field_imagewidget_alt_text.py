...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageWidget.title'
        db.add_column('fancypages_imagewidget', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageWidget.alt_text'
        db.add_column('fancypages_imagewidget', 'alt_text',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageWidget.title'
        db.delete_column('fancypages_imagewidget', 'title')

        # Deleting field 'ImageWidget.alt_text'
        db.delete_column('fancypages_imagewidget', 'alt_text')
