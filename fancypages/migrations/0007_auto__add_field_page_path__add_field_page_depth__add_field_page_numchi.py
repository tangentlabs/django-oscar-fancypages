...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.path'
        db.add_column('fancypages_page', 'path', self.gf('django.db.models.fields.CharField')(default='0000', unique=True, max_length=255), keep_default=False)

        # Adding field 'Page.depth'
        db.add_column('fancypages_page', 'depth', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'Page.numchild'
        db.add_column('fancypages_page', 'numchild', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.path'
        db.delete_column('fancypages_page', 'path')

        # Deleting field 'Page.depth'
        db.delete_column('fancypages_page', 'depth')

        # Deleting field 'Page.numchild'
        db.delete_column('fancypages_page', 'numchild')
