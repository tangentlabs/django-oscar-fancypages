...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.visible_on_mobile'
        db.add_column('fancypages_page', 'visible_on_mobile',
    ...
    def backwards(self, orm):
        # Deleting field 'Page.visible_on_mobile'
        db.delete_column('fancypages_page', 'visible_on_mobile')
