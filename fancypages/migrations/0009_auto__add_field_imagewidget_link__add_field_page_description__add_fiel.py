...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageWidget.link'
        db.add_column('fancypages_imagewidget', 'link',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.description'
        db.add_column('fancypages_page', 'description',
    ...
    def backwards(self, orm):
        # Deleting field 'ImageWidget.link'
        db.delete_column('fancypages_imagewidget', 'link')
