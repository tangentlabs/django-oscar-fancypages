...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageAndTextWidget.title'
        db.add_column('fancypages_imageandtextwidget', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageAndTextWidget.alt_text'
        db.add_column('fancypages_imageandtextwidget', 'alt_text',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageAndTextWidget.link'
        db.add_column('fancypages_imageandtextwidget', 'link',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageAndTextWidget.title'
        db.delete_column('fancypages_imageandtextwidget', 'title')

        # Deleting field 'ImageAndTextWidget.alt_text'
        db.delete_column('fancypages_imageandtextwidget', 'alt_text')

        # Deleting field 'ImageAndTextWidget.link'
        db.delete_column('fancypages_imageandtextwidget', 'link')
