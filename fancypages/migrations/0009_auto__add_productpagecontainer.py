...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fancypages_productpagecontainer', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_page_containers', to=orm['catalogue.Product'])),
        ))
    ...
    models = {
        ...
        'fancypages.productpagecontainer': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_page_containers'", 'to': "orm['catalogue.Product']"})
        },
