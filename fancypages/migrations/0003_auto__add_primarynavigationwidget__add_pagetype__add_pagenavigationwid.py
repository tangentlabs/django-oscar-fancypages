...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fancypages_page', 'page_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pages', null=True, to=orm['fancypages.PageType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('fancypages_page', 'page_type_id')
