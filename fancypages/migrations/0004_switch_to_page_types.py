...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        loaddata(orm, 'page_types.json')
        for page in orm.Page.objects.all():
            try:
                pt = orm.PageType.objects.get(template_name=page.template_name)
            except orm.PageType.DoesNotExist:
                __, name = page.template_name.rsplit('/', 1)
                pt = orm.PageType.objects.create(
                    name=name,
    ...
    def backwards(self, orm):
        ...
        for page in orm.Page.objects.all():
            page.template_name = page.page_type.template_name
            page.save()

        orm.PageType.objects.all().delete()
