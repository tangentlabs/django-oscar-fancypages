...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageWidget.image_asset'
        db.alter_column('fancypages_imagewidget', 'image_asset_id', self.gf('fancypages.assets.fields.AssetKey')(null=True, to=orm['assets.ImageAsset']))

    def backwards(self, orm):

        # Changing field 'ImageWidget.image_asset'
        db.alter_column('fancypages_imagewidget', 'image_asset_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['assets.ImageAsset']))
