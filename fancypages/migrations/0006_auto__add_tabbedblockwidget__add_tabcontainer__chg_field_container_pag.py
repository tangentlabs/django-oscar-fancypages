...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.page'
        db.alter_column('fancypages_container', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fancypages.Page']))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Container.page'
        raise RuntimeError("Cannot reverse this migration. 'Container.page' and its values cannot be restored.")
