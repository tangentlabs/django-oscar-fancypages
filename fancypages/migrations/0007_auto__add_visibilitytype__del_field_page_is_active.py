...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('fancypages_page', 'is_active')

        # Adding M2M table for field visibility_types on 'Page'
        db.create_table('fancypages_page_visibility_types', (
        ...
        db.create_unique('fancypages_page_visibility_types', ['page_id', 'visibilitytype_id'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('fancypages_page', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Removing M2M table for field visibility_types on 'Page'
        db.delete_table('fancypages_page_visibility_types')
