...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Widget.visible_on_mobile'
        db.add_column('fancypages_widget', 'visible_on_mobile',
    ...
    def backwards(self, orm):
        # Deleting field 'Widget.visible_on_mobile'
        db.delete_column('fancypages_widget', 'visible_on_mobile')
