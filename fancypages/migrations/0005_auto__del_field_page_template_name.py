...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('fancypages_page', 'template_name')


    def backwards(self, orm):
        # Adding field 'Page.template_name'
        db.add_column('fancypages_page', 'template_name',
                      self.gf('django.db.models.fields.CharField')(default='fancypages/pages/page.html', max_length=255),
                      keep_default=False)
