...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('fancypages_page', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['fancypages.Page'], blank=True), keep_default=False)
