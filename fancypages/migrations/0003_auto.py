...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field display_on_sites on 'Widget'
        db.create_table('fancypages_widget_display_on_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('widget', models.ForeignKey(orm['fancypages.widget'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('fancypages_widget_display_on_sites', ['widget_id', 'site_id'])

        # Adding M2M table for field display_on_sites on 'Page'
        db.create_table('fancypages_page_display_on_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('page', models.ForeignKey(orm['fancypages.page'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('fancypages_page_display_on_sites', ['page_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field display_on_sites on 'Widget'
        db.delete_table('fancypages_widget_display_on_sites')

        # Removing M2M table for field display_on_sites on 'Page'
        db.delete_table('fancypages_page_display_on_sites')
