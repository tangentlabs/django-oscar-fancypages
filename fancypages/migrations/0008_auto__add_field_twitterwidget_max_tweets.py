...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterWidget.max_tweets'
        db.add_column('fancypages_twitterwidget', 'max_tweets',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterWidget.max_tweets'
        db.delete_column('fancypages_twitterwidget', 'max_tweets')
