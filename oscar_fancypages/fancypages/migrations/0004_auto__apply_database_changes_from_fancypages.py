...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageNavigationBlock.depth'
        db.add_column('fancypages_pagenavigationblock', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'PageNavigationBlock.is_relative'
        db.add_column('fancypages_pagenavigationblock', 'is_relative',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageNavigationBlock.depth'
        db.delete_column('fancypages_pagenavigationblock', 'depth')

        # Deleting field 'PageNavigationBlock.is_relative'
        db.delete_column('fancypages_pagenavigationblock', 'is_relative')
